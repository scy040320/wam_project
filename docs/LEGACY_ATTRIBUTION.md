# Historical snapshot: mismatch attribution prototype

> **Archived protocol, not current project status.** This page preserves the earlier
> attribution-stage README. Its completion claims and metrics describe that earlier
> experiment only; they do not validate the current paired-treatment direction.
> Earlier four-step data and later native-horizon control must not be treated as
> interchangeable evidence. See the [current README](../README.md).
...
![Historical attribution and localization results](assets/attribution_results.png)

![Historical paired online recovery comparison](assets/paired_online_comparison.png)
...
See [native-horizon control protocol](NATIVE16_CONTROL_PROTOCOL.md) and [paired recovery comparison](PAIRED_RECOVERY_COMPARISON.md) for protocol boundaries and interpretation.
